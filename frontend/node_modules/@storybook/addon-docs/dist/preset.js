import CJS_COMPAT_NODE_URL_ta0pj14hz4 from 'node:url';
import CJS_COMPAT_NODE_PATH_ta0pj14hz4 from 'node:path';
import CJS_COMPAT_NODE_MODULE_ta0pj14hz4 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_ta0pj14hz4.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_ta0pj14hz4.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_ta0pj14hz4.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-PJ6BY35G.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-GXT3AUC3.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-K7XJG53M.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-5AO2VUFZ.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
