...
import {
  compile
} from "./chunk-5ATQEHQU.js";
import "./chunk-LFHCTCIU.js";
import "./chunk-HZBLDXDB.js";
import {
  __commonJS,
  __toESM
} from "./chunk-PJ6BY35G.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-GXT3AUC3.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-K7XJG53M.js")).default;
  return {
