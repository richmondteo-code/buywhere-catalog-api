import CJS_COMPAT_NODE_URL_kec89xjgd4l from 'node:url';
import CJS_COMPAT_NODE_PATH_kec89xjgd4l from 'node:path';
import CJS_COMPAT_NODE_MODULE_kec89xjgd4l from "node:module";

var __filename = CJS_COMPAT_NODE_URL_kec89xjgd4l.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_kec89xjgd4l.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_kec89xjgd4l.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-2CFKIW7K.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-44U3PGXW.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-FIR43JGQ.js";
import {
  detectPnp
} from "../_node-chunks/chunk-LTDMEZLE.js";
import "../_node-chunks/chunk-VPFWQV7X.js";
import {
  StorybookError
} from "../_node-chunks/chunk-W34SOEQW.js";
import {
  telemetry
} from "../_node-chunks/chunk-DIONJ7BC.js";
import "../_node-chunks/chunk-2XJI7BIG.js";
import {
...
} from "../_node-chunks/chunk-GOY6UMCB.js";
import "../_node-chunks/chunk-SD5ADQ63.js";
import "../_node-chunks/chunk-UZNYGMTS.js";
import {
  logger,
  require_pretty_hrtime
} from "../_node-chunks/chunk-CHOXZXZB.js";
import "../_node-chunks/chunk-QP7OGHAZ.js";
import "../_node-chunks/chunk-W4GYDBXZ.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-KIK2P2SN.js";
import "../_node-chunks/chunk-TLGJZBSI.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-YBRG5EIF.js";
import {
  dirname,
  isAbsolute,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-NGS5POET.js";
import {
  slash
} from "../_node-chunks/chunk-PIV5V757.js";
import "../_node-chunks/chunk-BXBMLGTU.js";
import {
  Tag
} from "../_node-chunks/chunk-D4PPIIAS.js";
import {
  require_dist
} from "../_node-chunks/chunk-VZNY2B6N.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-HZF6LPDY.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-RM4A5SWZ.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-ZEHLWQMG.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-EYIS5ER3.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-MZLI7YOS.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-ODHTGV2Q.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-MZLI7YOS.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
