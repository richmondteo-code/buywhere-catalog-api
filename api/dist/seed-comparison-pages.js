...
const SEEDS = [
    {
        ...
        expertSummary: 'The TP-Link Tapo C100 is one of the best-value home security cameras in Singapore. ' +
    ...
    },
    {
        ...
        category: 'electronics',
        expertSummary: 'The GoPro Hero13 Black Creator Edition bundles the flagship action camera with accessories for content creators. ' +
    ...
    },
    {
        ...
        category: 'electronics',
        expertSummary: 'The DJI OSMO Pocket 3 is the most portable gimbal camera for travel and daily shooting. ' +
...
async function seed() {
    for (const s of SEEDS) {
       ...
       RETURNING id, slug, status`, [s.slug, s.productIds, s.category, s.expertSummary]);
