...
async function runMigrations() {
    ...
    try {
        await config_1.db.query(`ALTER TABLE products ALTER COLUMN url_hash DROP NOT NULL`);
    ...
    try {
        await config_1.db.query(`ALTER TABLE products ALTER COLUMN domain DROP NOT NULL`);
